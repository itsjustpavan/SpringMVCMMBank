package com.mycompany.app.account.ui;
...
import com.mycompany.app.account.service.SavingsAccountServiceImpl;
...
public class AccountCUI {
	...
	private void updateAccountTypes(int select, SavingsAccount savingsaccount) throws ClassNotFoundException, SQLException {
